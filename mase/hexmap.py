...
from .agentstatepool import AgentState, AgentID
...
class HexMap(BaseHexMap):
    locs: typing.Dict[Position, Location]
    agent_pos: typing.Dict[AgentID, Position]
    
    def __init__(self, radius: int, default_state: LocationState = None, PositionType: type = CyHexPosition):
        '''
        Args:
...
class HexMapView(HexMap):
    __slots__ = ['locs', 'agent_pos', 'PositionType']
